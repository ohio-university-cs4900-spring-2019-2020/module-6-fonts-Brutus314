...
void GLViewFonts::updateWorld()
{
	GLView::updateWorld(); //Just call the parent's update world first.
						  ...
						  //this call
	// Send camera net message to update an item's location
	NetMsgCameraObject msg;
	msg.location = this->cam->getPosition();
	msg.look = this->cam->getLookDirection();
	msg.name = name;
...
void GLViewFonts::onKeyDown(const SDL_KeyboardEvent& key)
{
	...
	{
		// Make a stack on the other setup
